...
from data_loader import Merged_Data_Dataset, NumpyLoader
...
def get_args_parser():
    ...
    parser.add_argument('--n_input_vars', default=20, type=int,
                        help='images input size')
    ...
    # dataset parameters
    parser.add_argument('--file_dir', default='../../NASA_Citizen_Science/data/merged_data/SF', type=str,
...
def main(args):
    ...
    # init the dataset
    dataset = Merged_Data_Dataset(args.file_dir)
